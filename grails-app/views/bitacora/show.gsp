...
<!--                        <tr class="prop">
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="bitacora.usuario.label" default="Usuario" /></td>

                            <td valign="top" class="value">${fieldValue(bean: bitacoraInstance, field: "usuario")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="bitacora.comentario.label" default="Comentario" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: bitacoraInstance, field: "comentario")}</td>
