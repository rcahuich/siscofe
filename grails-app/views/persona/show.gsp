        ...
        <div class="body">
            ...
            <div class="buttons">
                <g:form>
                    ...
                    <span class="menuButton"><g:link controller="baja" params="[personaId:personaInstance.id, personaNombre:personaInstance.nombre]" class="delete" action="create" > <g:message code="Dar de Baja" /></g:link></span> |
