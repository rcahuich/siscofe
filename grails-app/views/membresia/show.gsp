            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="membresia.id.label" default="Id" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: membresiaInstance, field: "id")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="membresia.persona.label" default="Persona" /></td>
                            
                            <td valign="top" class="value"><g:link controller="persona" action="show" id="${membresiaInstance?.persona?.id}">${membresiaInstance?.persona?.encodeAsHTML()}</g:link></td>
